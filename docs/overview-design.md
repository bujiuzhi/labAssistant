...
生产首次 bootstrap 原子创建内部平台组织及平台管理员、首个业务组织及其超级管理员。平台管理员可开通后续独立组织，并为每个新组织原子创建首个超级管理员、三个内置角色及其权限；该组织管理员不继承平台权限。组织管理员可直接创建本组织普通用户，或签发绑定本组织角色和有效期的一次性邀请码；邀请码库仅保存 SHA-256 哈希，明文只在签发时返回一次。注册用户不能自行选择组织、角色或超级管理员身份。
