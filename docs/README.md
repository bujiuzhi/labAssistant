...
_材料实验助手正式文档入口；更新时间：2026-09-11，时区：Asia/Shanghai。_
...
| 文档 | 负责内容 | 主要读者 |
| --- | --- | --- |
| [概要设计](overview-design.md) | 目标、能力边界、用户与权限模型、系统架构、验收范围 | 产品、研发与交接负责人 |
| [详细设计](detailed-design.md) | 数据模型、接口语义、授权与数据范围、状态、页面、已知限制 | 开发、测试、评审人员 |
