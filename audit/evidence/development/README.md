...
| `materials-lab-project-overview-2026-07-30.png` | 项目概览 | 五阶段里程碑、基础信息、独立项目外壳 |
| `materials-lab-eln-mobile-2026-07-30.png` | 移动端电子实验记录本 | 375×900、状态切换、主从记录与底部操作区 |

## 生成边界

- 截图由本机通过 SSH 隧道访问远程开发服务后生成。
- 截图只包含可重复初始化的开发数据，不包含生产数据；临时浏览器验收项目已在截图前清理。
