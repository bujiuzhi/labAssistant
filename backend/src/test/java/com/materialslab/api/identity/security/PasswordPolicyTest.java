...
class PasswordPolicyTest {
    @Test
    void 应接受至少八位且包含字母数字的普通密码() {
        assertThatCode(() -> PasswordPolicy.validateManagedPassword("lab2026x", "researcher"))
                .doesNotThrowAnyException();
    }

    @Test
    void 应拒绝短密码单一字符类别含空白密码和用户名口令() {
        for (String password : new String[] { "1234567", "password", "12345678", "pass word", "researcher" }) {
