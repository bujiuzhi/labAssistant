...
/** 实验计划与 ELN 基础数据投影。 */
public record Experiment(UUID id, UUID organizationId, UUID projectId, String experimentNo, String name,
                         String experimentType, String phase, String status, String purpose, UUID ownerId,
                         String ownerName, Integer version, OffsetDateTime estimatedStart, OffsetDateTime estimatedEnd,
